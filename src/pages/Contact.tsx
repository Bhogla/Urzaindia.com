              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Raj Tower, Opp. Nirankari Satsang Bhawan, Haridwar Bypass Road, Dehradun-248001</p>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@aasnaurza.com">info@aasnaurza.com</a>
                    </p>
                  </div>
                </div>
              </div>
